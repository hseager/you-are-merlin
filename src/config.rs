...
pub const ITEM_GEN_CRIT_MULTI: (f32, f32) = (0.2, 2.0);
pub const ITEM_GEN_CRIT_CHANCE: (f32, f32) = (2.0, 8.0);

pub const ITEM_GEN_MAX_LIFE: (i16, i16) = (10, 60);
pub const ITEM_GEN_BLOCK: (u16, u16) = (2, 10);
