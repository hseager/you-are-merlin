...
use crate::{actions::{Action, ActionItem}, location::{get_locations_display_list, LocationItem}};
    ...
    pub fn execute_action(&mut self, search: &str) -> () {
        ...
        match action.class {
            Action::Explore => {
                ...
                println!("You begin to explore {}, but a giant spider appears.", self.location.display_label());
