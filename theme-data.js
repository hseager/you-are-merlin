...
const theme = {
    ...
    locations: [
        ...
        {
            name: "Camelot Tavern",
            description: "Lively hub in Camelot's heart, offering hearty meals and merry company."
        },        
        {
            name: "Forest of Balor",
            description: "Verdant labyrinth cloaked in ancient mystery, hiding forgotten secrets."
        },        
        {
            name: "Darkling Woods",
